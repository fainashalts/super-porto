...
import { extractTransactionDepositedLogs, extractWithdrawalMessageLogs, getL2TransactionHashes, } from 'viem/op-stack';
import { describe, expect, it } from 'vitest';
import { optimismMintableERC20FactoryAbi } from '../abis.js';
import { depositERC20 } from './depositERC20.js';
import { estimateWithdrawOptimismERC20Gas, simulateWithdrawOptimismERC20, withdrawOptimismERC20, } from './withdrawOptimismERC20.js';
...
describe('withdrawOptimismERC20', async () => {
    ...
    const { contractAddress: wethAddress } = await publicL1Client.waitForTransactionReceipt({
    ...
    const { logs: depositTxLogs } = await publicL1Client.waitForTransactionReceipt({ hash: depositTxHash });
    ...
    describe('simulate', () => {
        it('should simulate', async () => {
            expect(async () => await simulateWithdrawOptimismERC20(publicClientA, {
                account: testAccount,
                tokenAddress: l2TokenAddress,
                amount: 1n,
            })).not.throw();
...
//# sourceMappingURL=withdrawOptimismERC20.spec.js.map