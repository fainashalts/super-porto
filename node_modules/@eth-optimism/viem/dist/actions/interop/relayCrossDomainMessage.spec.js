...
describe('relayMessage', () => {
    ...
    describe('estimate gas', () => {
        it('should estimate gas', async () => {
            ...
            const gas = await publicClientB.interop.estimateRelayCrossDomainMessageGas({
                account: testAccount.address,
                ...params,
            });
    ...
    describe('simulate', () => {
        it('should simulate', async () => {
            ...
            expect(() => publicClientB.interop.simulateRelayCrossDomainMessage({
                account: testAccount,
                ...params,
            })).not.throw();
        });
    ...
    describe('write contract', () => {
        it('should return expected request', async () => {
            ...
            const relayTxHash = await walletClientB.interop.relayCrossDomainMessage(params);
...
//# sourceMappingURL=relayCrossDomainMessage.spec.js.map