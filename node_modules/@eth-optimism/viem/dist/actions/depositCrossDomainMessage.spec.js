...
import { depositCrossDomainMessage, estimateDepositCrossDomainMessageGas, simulateDepositCrossDomainMessage, } from './depositCrossDomainMessage.js';
...
describe('depositCrossDomainMessage', () => {
    ...
    describe('simulate', () => {
        it('should simulate', async () => {
            expect(async () => await simulateDepositCrossDomainMessage(publicL1Client, {
                account: testAccount,
                target: '0x0000000000000000000000000000000000000000',
                message: '0xabcd',
                l1CrossDomainMessengerAddress,
...
//# sourceMappingURL=depositCrossDomainMessage.spec.js.map